...
def test_gitignore_contains_step33a_artifact_patterns():
...
def test_step33a_outputs_are_ignored_run_dir_not_data_or_checkpoints():
    ...
    assert "runs/bridgedata_v2_tfds_true_temporal_step33a_v1" in output_text
...
def test_step33a_staged_files_do_not_include_large_or_secret_artifacts():

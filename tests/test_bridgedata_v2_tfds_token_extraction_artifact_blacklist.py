...
def test_gitignore_contains_step24_artifact_patterns():
...
def test_step24_outputs_do_not_target_data_shard_dirs():
    config = yaml.safe_load(Path("configs/bridgedata_v2_tfds_token_extraction_step24.yaml").read_text(encoding="utf-8"))
    ...
    assert "runs/bridgedata_v2_tfds_token_extraction_step24_v1" in output_text

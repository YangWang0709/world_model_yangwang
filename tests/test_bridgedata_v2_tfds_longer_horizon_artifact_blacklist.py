...
def test_gitignore_contains_step32_artifact_patterns():
...
def test_step32_outputs_are_ignored_run_dir_not_data_or_checkpoints():
    ...
    assert "runs/bridgedata_v2_tfds_longer_horizon_step32_v1" in output_text
...
def test_step32_staged_files_do_not_include_large_or_secret_artifacts():

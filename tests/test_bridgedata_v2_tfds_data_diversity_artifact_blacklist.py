...
def test_gitignore_contains_step33b_artifact_patterns():
...
def test_step33b_outputs_are_ignored_run_dir_not_data_or_checkpoints():
    ...
    assert "runs/bridgedata_v2_tfds_data_diversity_step33b_v1" in output_text
...
def test_step33b_staged_files_do_not_include_large_or_secret_artifacts():

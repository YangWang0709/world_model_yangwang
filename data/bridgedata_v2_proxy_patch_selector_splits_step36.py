"""Shard-aware split settings for Step36 proxy patch/token selector smoke."""
...
def build_step36_training_settings(config: dict[str, Any]) -> list[dict[str, Any]]:
...
def summarize_step36_leakage(settings: list[dict[str, Any]]) -> dict[str, Any]:
...
def _setting(
    *,
    ...
    val: dict[str, list[Any]],
    train_traj: dict[str, list[Any]],
    val_traj: dict[str, list[Any]],
) -> dict[str, Any]:
